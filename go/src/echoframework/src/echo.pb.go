...
func (*EchoReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_echo_13c504789862e0e6, []int{0}
}
...
func (*EchoRes) Descriptor() ([]byte, []int) {
	return fileDescriptor_echo_13c504789862e0e6, []int{1}
}
...
func (dst *EchoRes) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EchoRes.Merge(dst, src)
}
...
func init() { proto.RegisterFile("echo.proto", fileDescriptor_echo_13c504789862e0e6) }

var fileDescriptor_echo_13c504789862e0e6 = []byte{
